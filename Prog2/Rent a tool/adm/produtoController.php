			...
			case "cadastro":
				...
				if(isset($_POST['cadastrar'])) {
					...
					if($resultado) {
						...
						$mensagem = "O produto <strong>{$dados['nome']}</strong> não foi cadastrado com sucesso!";
			...
			case "altera":
				...
				if(isset($_POST['alterar'])) {
					...
					if($resultado) {
						...
						$mensagem = "O produto <strong>{$dados['nome']}</strong> não foi alterado com sucesso!<br>";
						$mensagem .= $produto->erro();
					}
					include "views/produtoConfirmacao.php";
				}
			...
			case "exclui":
				...
				if(is_numeric($_GET['id'])) {
					...
					if($resultado) {
						...
						$mensagem = "O produto não foi excluído com sucesso!<br>";
						$mensagem .= $produto->erro();	
					}
				}
				else { //nao eh numero
